...
const copy = {
  fr: {
    ...
    fourBillionTitle: "4 milliards de voix.",
    ambitionNotMetric: "Une ambition, pas un chiffre acquis.",
    fourBillionBody: "Notre mission à long terme est de bâtir une infrastructure civique ouverte et fiable qui permette à 4 milliards de personnes de mieux débattre, partout dans le monde. Nous commençons ici, avec une question qui compte.",
  ...
  en: {
    ...
    fourBillionTitle: "4 billion voices.",
    ambitionNotMetric: "An ambition, not a claimed metric.",
    fourBillionBody: "Our long-term mission is to build open, trusted civic infrastructure that helps 4 billion people debate better, everywhere. We are starting here, with one question that matters.",
